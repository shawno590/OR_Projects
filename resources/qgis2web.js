...
map.getView().fit([-13144115.844278, 5672272.270944, -13143865.871309, 5672565.549576], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">LaGrande Soft Surface</h2>';
        return titleElement;
    })(),
